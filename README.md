...
|---|---:|
| 0G Chain registry entries | 44 analyses recorded on 0G mainnet |
| Signed registry writes | 100% of current registry metrics are EIP-712 operator verified |
| 0G-backed memory records | 19 total memory records |
...
| Critic activity | 89 challenges across 23 tracked runs |
